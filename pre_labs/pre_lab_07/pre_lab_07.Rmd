...
**Answer** I see charts that list the numbers and letters that translate to different naics codes and what each figure means.
...
**Answer** I see the HTML code of the webpage and how it is formatted. 
...
**Answer** The output that appears is some HTML from the webpage.
...
**Answer** It pulled in the <html>, <head>, and <body> sections.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** I see more of the HTML code for the chart displayed. It has the numbers and the industry.
...
**Answer** Six tables were made from the codeblock. It seems like it's identifying the values and making templates for the positions and example values. 
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It shows six different tables. It seems like the tables that we loaded from here all compiled into one area.
...
**Answer** There's a chart that has the naics from certain years, the months they were implemented, and the dates they were released.
...
**Task** Follow the directions in the previous paragraph. Briefly describe what you see there.
**Answer** It is a chart with the sector numbers and what industry descriptions they match up with.
...
**Answer** It is a real dataframe that can be used in R instead of like a table or chart format 
...
**Answer** The dataframe is cleaner and fits nicely on one page instead of being formatted weirdly with one column on one page and another on the next.
...
**Answer** Its the cleaned dataframe from before with the sector numbers and the naics codes.
```{r}
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It had the data for employment and unemployment in utilities in a chart.
...
**Task** Run the following code to read in the html. Briefly describe the output that appears below the codeblock.
**Answer** It is a similar beginning HTML code as before where it has the <head> and <body>.
...
**Answer** The code that appears is the code that we want that has the information from the table that we need and not the code from before.
...
**Answer** It is a dataframe of the chart from the webpage with the unemployment and employment.
...
**Answer** The dataframe is now focusing on all employment from june 2021.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It has the same unemployment and employment graphs but for mining, quarrying, oil and gas extraction.  
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer**It has the same unemployment and employment graphs but for construction.
...
**Answer** The dataframe lists all of the industries that we asked to print.
```{r}
...
**Answer** I did not get an output below the codeblock but I got a little something in the Values section in the Global Environment. It won't open, but also I think it isn't supposed to.
```{r}
...
**Answer** I see the same list as before, but we did not have to put print in front of everything this time.
```{r}
...
**Answer** I got an error that said "sector_list not found."
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** I got the same ten industries that we got in the last two dataframes.
```{r}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Task** Run the following code to use a for loop to print list of sectors. Briefly describe the output that appears below the codeblock.
**Answer** Another error that says "object 'sector_name' not found."
```{r, error=TRUE}
# Define list of sectors
list_of_sectors <- c("Agriculture, Forestry, Fishing and Hunting", "Mining, Quarrying, and Oil and Gas Extraction", "Utilities", "Construction", "Manufacturing",
"Wholesale Trade", "Retail Trade", "Transportation and Warehousing", "Information", "Finance and Insurance")
...
**Answer** It just lists numbers from 1-10.
```{r}
# For loop that includes instructions that refer to a variable that doesn't exist.
for (number in 1:10) {
  print(number)
...
**Answer** It is listing the naics code numbers and the industry for each number.
...
**Answer** It counted the rows and said there were 20.
...
**Answer** It counted and listed out the rows 1-20
...
**Answer** It isolated the code for the number of employees for June 2021.
...
**Task** Run the following code to load table from last chapter. Briefly describe the output that appears below the codeblock.
**Answer** It gave the sector number and the industry it corresponds with.
```{r}
# Define url of page we want to scrape
...
**Answer** It has the sector numbers and the industry for each number, but it is not next to each other like in some parts, and it has the sector URL.
...
**Answer** Similar thing as above, but now it has sector xpath id.
...
**Answer** same thing has above but there is one less row.
...
**Answer** We got a lot of different dataframes that separated the industries and only displays one in each.
...
**Answer** It lists the row numbers in order from 1-19 with the links and xpaths.
```{r}
...
**Answer** It shows the employment information for different industries in different dataframes.
...
**Answer** The employment numbers from june 2021 to september 2021 for each of the different industries.
...
**Answer** It has the same things as above but now it also includes the industry description.
...
**Task** Run the following for loop to clean up tables. Briefly describe the output that appears below the codeblock.
**Answer** The data frames are cleaned up to only show the sector number, the industry description and the june 2021 employees.
...
**Answer** This dataframe has the sector numbers, descriptions, and the number of june 2021 employees.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It is the workforce statistics for the mining industry.
...
**Task** Visit the web page linked above. Briefly describe what you see there.
**Answer** It has the different workforce statistics for the agriculture industry.
...
**Answer** This had the sector, description and june 2021 employees but has NA for agriculture.
