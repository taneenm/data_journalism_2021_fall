...
**Answer** I see different types of files that have information on hospitals.
...
**Answer** There are 33 columns that exist in this data. Some of the columns include things for location like coordinates, address, zip code, etc. Other columns have photos, website links, things the hospital offers, geometry and more.  
...
**Answer** The output is a dataframe of just hospitals in Baltimore. It has the same columns as above. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It grouped by each type of hospital and counted how many there were of each. It also included the geometry for each type.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This only shows the MD general acute care hospitals and all of the columns from the original dataframe.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** There is a scatterplot that shows where the hospitals are in Maryland. The dots also make a rough shape of Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It loaded in the tigris package.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** The output shows the counties, state numbers, geometry, along with some other columns that I don't really know what they mean. 
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It filtered out the other counties and kept the Maryland counties. It kept the previous columns too.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is a map of the state of Maryland, and its counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This placed the dots of the hospitals on the map of Maryland and its counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This changed the colors of the dots and created a gradient for the colors to show how many beds are available in each hospital.
...
**Answer** This loaded in the census api.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This has all of the general acute care facilities in Maryland and the counties that they're in. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** It is a dataframe with the counties and the beds in those counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This brings in the ACS data and has the population for each county in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This has the geometry along with the populations of counties in Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This just loaded the two dataframes of the county population from right above and the total beds in each county from earlier.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This renamed and mutated the columns in the population dataframe to get it ready for joining.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This joined the county population and the beds by county dataframes. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This replaced the responses that said "NA" with "0."
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This joined the dataframes, replaced "NA" with 0, and normalized the data by making a column for number of beds per 100,000. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This created the map of maryland and the counties. It also created a gradient to show how many beds per 100,000 for the counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer** This changed the color scheme from blue to a magma theme that we used before.
...
**Answer** This changed the scale to "log" so the differences show. The patterns that I see are that there are less beds in southern Maryland and more beds in nothern/north eastern Maryland.
