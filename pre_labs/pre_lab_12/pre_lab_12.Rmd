...
**Answer** The dataframe has the number of vaccinations that happen on each and how many doses were given all together at each date. It has first and second doses, full vaccinations, and single doses.
...
**Answer** There is an NA row and an unknown row. There are more rows than there are counties.
...
**Answer** The tibble shows the data for NA and their vaccination progress. It starts at 8000 and then adds one every day or every couple of days. I honestly am unsure what the data represents and am kind of confused.
...
**Answer** The pattern for the most recent 7-10 days is that it would be high for a day then go down, then get into a higher range again and then drop. The rank also is pretty low. 
...
**Answer** The chart is showing the number of vaccinations from Jan 2021 to Oct 2021. There were more vaccinations from April 2021 to around June 2021. 
...
**Answer** The description is "The number of people in Prince George's County fully vaccinated on November 14 decreased by -74.25 percent compared to the week before"
...
**Task** Run the following code and put the value of `sub` in the answer.
**Answer** It put the caption that we automated in the last question in the description for this graph.
...
**Answer** The chart shows COVID cases from each of the Maryland counties from July 2020 to July 2021. It also has "unkown."  
...
**Task** Run the following code and describe what the resulting chart shows
**Answer** The y-axis changed from regular numbers to exponential notation. It also made the increase very quick.
...
**Answer** There is only one row in the dataframe. 
...
**Answer** There are 24 rows in this dataframe. 
...
**Answer** The map is showing the number of COVID-19 cases as of Nov. 15, 2021 for each of the counties in Maryland. 
