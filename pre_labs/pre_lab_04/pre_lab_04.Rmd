...
**Answer** Yes the three CSV population estimate files have the same column structure.
...
**Answer** There are 195869 rows in maryland_ppp.
...
**Answer** There are still 195869 rows. 
...
**Answer** The error message says "can't join on `x$zip` x `y$zip` because of incompatible types. `x$zip` is of type <character>> and`y$zip` is of type <double>>." I think this means that I cannot combine these columns together because they are two different types.  
...
**Answer** No they don't have data; they all say NA.
...
**Answer** Number of loans is 44032. The average amount of those loans is 53836.46, and the median amount is 20000.
...
**Answer** There are 113937 loans. The average amount of the loans is 88140.24, and the median is 20833.
...
**Answer** The amount for rural is 148. The average amount of those loans is 44328.87, and the median is 19621. For urban the number is 43884. The average amount is 53868.53, and the median amount is 20000.
...
**Answer** The rural count is 18337. The average is 73694.14, and the median amount is 20833. The urban count is 95600. The average amount is 90911.14, and the median is 20833.
