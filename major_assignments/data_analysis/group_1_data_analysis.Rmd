...
#We plan to reorder/better organize the memo once our document is fully finished. For now, we’re still working on our individual sections to ensure we all have all the information together for the section we worked on. 
...
12/1/21-- The most interesting stuff so far: 
For Marvel: There was an agender character introduced in 1964 and then the next appearance was 1966. These characters were neutral and bad. There isn't a good agender character until 1979, but it goes back to bad/neutral. 
They had two female character appearances within the same month in 1939, one was neutral and one was good, then their next appearance for a female character was within the same year and was neutral. They had a homosexual character, who was a man, that was introduced a year after the female character, and was good. 
Huge gap between the two genderfluid characters: 1949 and 2005. They are neutral and good. 
What surprised me the most was generally how early these characters were added. I did not think a homosexual character would be added in 1940. Also, more of the first characters were neutral and good than I thought they would be. 
For DC: The GSM characters, they were later than I expected
